...
@section('admin')
    ...
    <div class="card-body">
        ...
        <input type="passwprd" class="form-control" name="old_password"
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9 text-secondary">
        <input type="passwprd" class="form-control" name="new_password" id="new_password"
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9 text-secondary">
        <input type="passwprd" class="form-control" name="new_password_confirmation" id="new_password_confirmation"
