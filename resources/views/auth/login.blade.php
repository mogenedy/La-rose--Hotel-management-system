            ...
            <div class="row">
                    ...
                    <div class="col-lg-12 ">
                        <div class="form-group">
                            <input type="text" name="loginname" id="loginname" class="form-control"   placeholder="Email,Name,Mobile" >
                             <x-input-error :messages="$errors->get('loginname')" class="mt-2 text-red-500 font-bold" style="background-color: #ffeeee;  color:red;" />
